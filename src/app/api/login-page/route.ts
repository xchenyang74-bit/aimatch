...
<head>
  ...
  <title>Aimatch</title>
  <style>
    body { margin: 0; min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #fff7ed, #fdf2f8); font-family: system-ui, sans-serif; padding: 16px; }
...
<body>
  <div class="card">
    ...
    <div class="feature f2"><span class="fi">💬</span><div><div class="ft">Agent 先聊，你再决定</div><div class="fd">基于 AI 对话报告</div></div></div>
    <div class="feature f3"><span class="fi">❤️</span><div><div class="ft">每日精选推荐</div><div class="fd">根据兴趣标签推荐</div></div></div>
