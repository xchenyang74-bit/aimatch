      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/50">
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="w-full py-4 bg-gradient-to-r from-orange-400 via-pink-400 to-purple-400 text-white rounded-xl font-semibold text-lg shadow-lg shadow-orange-200 hover:shadow-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
          ...
          <p className="mt-6 text-center text-sm text-gray-400">
            登录即表示你同意我们的
            <span className="text-orange-400 mx-1">服务条款</span>
            和
            <span className="text-orange-400 mx-1">隐私政策</span>
          </p>
        </div>
      </div>
    </div>
